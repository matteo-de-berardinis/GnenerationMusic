                    ...
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row"
                            ...
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                <img src="<%=b.getImg() %>" alt="Generic placeholder image"
                        ...
                        <div class="card-body p-4 text-black">
                            ...
                            <div id="info" class="collapse">
                                <div class="p-4 info-background rounde">
                                    
                                    <input type="text" class="form-control bg-dark" placeholder="Nome band: <%=b.getBand() %>"
                                        disabled><br>
                                    <input type="text" class="form-control bg-dark"
                                        placeholder="Anno di fondazione: <%=b.getAnnoFondazione() %>" disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Nazionalità: <%=b.getNazionalita() %>"
                                        disabled><br>
                                    <input type="text" class="form-control bg-dark"
                                        placeholder="Genere musicale: <%=b.getGenere() %> %>" disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Email: <%=b.getEmail() %>"
                                        disabled><br>
                            ...
                            <div class="d-flex justify-content-center my-5">
                                <a href="leMiePrenotazioniBand.jsp" class="btn btn-dark" data-bs-toggle="collapse">Prenotazioni</a>
                            </div>
                            
                             <div class="d-flex justify-content-center my-5">
                                <a href="inserisciGiorni.jsp" class="btn btn-dark">Inserisci giorni disponibili</a>
                            </div>
