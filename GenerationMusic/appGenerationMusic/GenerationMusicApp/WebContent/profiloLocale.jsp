...
<% Locale l = (Locale)session.getAttribute("locale");  %>
<body>
    <div class="container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4 text-black">
                            ...
                            <div id="info" class="collapse">
                                <div class="p-4 info-background rounded">
                                    ...
                                    <input type="text" class="form-control bg-dark" placeholder="Regione: <%=l.getRegione() %>"
                                        disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Proprietario: <%=l.getPropietario() %>"
                                        disabled><br>
                            ...
                            <div class="d-flex justify-content-center my-5">
                                <a href="leMiePrenotazioniLocale.jsp" class="btn btn-dark" data-bs-toggle="collapse">Prenotazioni</a>
                            </div>
