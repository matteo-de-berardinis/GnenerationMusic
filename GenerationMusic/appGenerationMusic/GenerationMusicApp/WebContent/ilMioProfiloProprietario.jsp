...
<%@ page
	import="model.Utente, model.Artista, model.Band, model.Locale, model.Cliente, model.Proprietario, DAO.giorniDispDAO, DAO.LocaleDAO, model.Proprietario" %>
                    ...
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row"
                            ...
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                <img src="<%=u.getImg() %>" alt="Generic placeholder image"
                        ...
                        <div class="card-body p-4 text-black">
                            ...
                            <div id="info" class="collapse">
                                <div class="p-4 info-background rounded">
                                    ...
                                    <input type="text" class="form-control bg-dark" placeholder="Nazionalità: <%=p.getNazionalita() %>"
                                        disabled><br>
...
List<Locale>lista= LocaleDAO.recuperListaLocaliProprietatio(p); 
for(Locale l:lista){%>
  <div class="col-sm-6 p-3">
	...
	<input type="hidden" name="operazione" value="vediLocale">
    <input type="hidden" name="dati_nascosti" value="<%=l.getId()%>">
    <input type="submit" class="btn btn-dark" value="vedi">
</form>
                                                    </div>
                                                </div>
                                            </div>
...
%>
                                    ...
                                    <div class="d-flex justify-content-center mt-3">
                                        <a href="registrazione_locale.jsp"><button type="button" class="btn btn-dark btn-lg" style="z-index: 1;">
                                            Aggiungi locale
                                        </button></a>
                                    </div>
                                </div>
