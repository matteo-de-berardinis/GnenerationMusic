...
<body style="background-image: url(img/tuttiArtisti.jpg); background-size: cover;margin-top:120px; ">
  <main>
    <div class="container my-3 rounded border bg-dark" style="min-width: 75%; text-align: center; margin-top: 120px;">
...
<%// Elenco nomi artisti
        ...
        <div class="col-md-8 col-lg-4 col-xl-3 col-xxl-2 my-3">
            <div class="cards_wrapper">
                <div class="card">
                <% if(a.getImg() != null){ %>
                    <img src="<%=a.getImg() %>" class="card-img-top" alt="immagini/band1.png">
                    <% } else { %>
                    <img src="img\avatar.png" class="card-img-top" alt="immagini/band1.png">
                    <% } %>
                    <div class="card-body">
