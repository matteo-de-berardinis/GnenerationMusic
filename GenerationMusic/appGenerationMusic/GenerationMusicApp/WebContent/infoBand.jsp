...
<%@ page import="model.Band, model.Locale, model.Cliente, model.Proprietario"%>
...
<body>
    ...
    Utente u2 = (Utente) session.getAttribute("utente");
        ...
        int media = CommentiBandDAO.mediaValutazioneBand(idBand);
    %>
...
<div class="container bg-dark rounded border px-4 pt-2 mb-2 text-white border border-light" style="margin-top: 290px; margin-left: 40px;  z-index: 2; width:fit-content; position: absolute; min-width: 250px;">
        ...
        <div class="container rounded-top border text-white d-flex flex-row" style="background-color: black; background-size: cover; background-repeat: no-repeat; background-position: center; height: 20rem; z-index: -1;">
        ...
        <div class="container bg-dark text-white py-5 border">
            <div class="row">
                ...
                <p>Nome Band: <%=b.getBand() %></p>
                    <p>Anno di Fondazione: <%=b.getAnnoFondazione() %></p>
                    
                    <p>Nazionalità: <%=b.getNazionalita() %></p>
                    <p>Genere: <%=b.getGenere() %></p>
                </div>
                ...
                <div class="container py-5" style="text-align: center">
                   ...
                   <h2 class="text-dark"> Disponibili in data:</h2>
...
<a href="prenotazioneBand.jsp" class="btn btn-danger btn-lg">Prenota </a>
</div>
                <!--Fine carousel-->
                <br><br>
            </div>
...
<input type="hidden" name="operazione" value="inserisciCommentoBand">
<div class="container-fluid bg-dark my-5 py-5 text-dark rounded">
            ...
            <input type="hidden" name="idBand2" value="<%= b.getIdBand() %>">
                 ...
                 <div class="mt-3">
                                                    ...
                                                    <input id="voto" class="form-control" type="number" name="valutazione2" min="0"
                                                        max="100" />
