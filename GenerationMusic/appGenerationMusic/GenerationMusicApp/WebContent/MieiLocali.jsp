...
<%@ page import="DAO.artistiDAO, DAO.LocaleDAO"%>
...
<body style="background-image: url(img/ws_Dance_Music.jpg); background-size: cover; margin-top: 110px; ">
...
for(Locale l:lista){%>
    ...
    <input type="submit" class ="btn btn-dark btn-lg" value="Profilo">
</form>
