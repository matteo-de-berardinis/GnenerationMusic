                    ...
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row"
                            ...
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                ...
                                <a class="dropdown-item" href="modificaCliente.jsp"><button type="button" class="btn btn-dark" style="z-index: 1;">
                                    Modifica Profilo
                                </button></a><br>
                        ...
                        <div class="card-body p-4 text-black">
                            ...
                            <div id="info" class="collapse">
                                <div class="p-4 info-background rounded">
                                    ...
                                    <input type="text" class="form-control bg-dark" placeholder="Nome: <%=c.getNome() %>"
                                        disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Cognome: <%=c.getCognome() %>"
                                        disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Anno di nascita: <%=c.getAnnoNascita() %>"
                                        disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Nazionalità: <%=c.getNazionalita() %>"
                                        disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Email: <%=c.getEmail() %>" disabled><br>
                            ...
                            <div class="d-flex justify-content-center my-5">
                                <a href="leMiePrenotazioniCliente.jsp" class="btn btn-dark">Prenotazioni</a>
                            </div>
