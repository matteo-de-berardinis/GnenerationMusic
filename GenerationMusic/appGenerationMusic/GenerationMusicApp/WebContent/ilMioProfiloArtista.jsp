                    ...
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row"
                            ...
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                <img src="<%=a.getImg() %>" alt="Generic placeholder image"
                        ...
                        <div class="card-body p-4 text-black">
                            ...
                            <div id="info" class="collapse">
                                <div class="p-4 info-background rounded">
                                    ...
                                    <input type="text" class="form-control bg-dark" placeholder="Nome d'arte: <%=a.getNomeArtista() %>"
                                        disabled><br>
                                        
                                    <input type="text" class="form-control bg-dark"
                                        placeholder="Anno di nascita: <%=a.getAnnoNascita() %>" disabled><br>
                                        
                                    <input type="text" class="form-control bg-dark" placeholder="Nazionalità: <%=a.getNazionalita() %>"
                                        disabled><br>
                                        
                                    <input type="text" class="form-control bg-dark"
                                        placeholder="Genere musicale: <%=a.getGenere() %>" disabled><br>
                                    <input type="text" class="form-control bg-dark" placeholder="Email: <%=a.getEmail() %>"
                                        disabled><br>
                            ...
                            <div class="d-flex justify-content-center my-5">
                                <a href="leMiePrenotazioniArtista.jsp" class="btn btn-dark">Prenotazioni</a>
                            </div>
