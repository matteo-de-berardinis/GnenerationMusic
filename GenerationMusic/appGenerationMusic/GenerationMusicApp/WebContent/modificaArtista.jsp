...
<body>
 <%Artista a = (Artista)session.getAttribute("artista"); %>
	...
	<main>
		...
		<input type="hidden" name="operazione" value="modificaProfiloArtista">
            ...
            <td><input type="text" class="form-control-sm" name="username" id="username" placeholder="<%=a.getNickname() %>"> 
            </td><br>
            </tr>

            <tr>  
            <th> <label for="nomearte">Nome d'Arte:</label></th>
            <td><input  type="text" class="form-control-sm" name="nomearte" id="nomearte" placeholder="<%=a.getNomeArtista() %>"> 
           </td>
            </tr> 
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="genere" id="genere" class="form-select-sm">
                        <option value="<%=a.getGenere() %>" selected disabled> <%=a.getGenere() %> </option>
			...
			<td><input type="email" class="form-control-sm" name="email" id="email" placeholder="<%=a.getEmail() %>"> 
            </td><br>
            </tr>
			...
			<td><input type="password" class="form-control-sm" name="pass" id="pwd" placeholder="<%=a.getPassword() %>"> 
            </td><br>
            </tr>
