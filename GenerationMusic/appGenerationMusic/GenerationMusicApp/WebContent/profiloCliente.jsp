                            ...
                            <div id="info" class="collapse">
                                <div class="p-4 info-background rounded">
                                    ...
                                    <input type="text" class="form-control bg-dark" placeholder="Nazionalità: <%=c.getNazionalita() %>"
                                        disabled>
                                        <br>
                                    <input type="text" class="form-control bg-dark" placeholder="Email: <%=c.getEmail() %>" disabled>
                                    <br>
                                    <input type="text" class="form-control bg-dark" placeholder="Città di residenza: <%=c.getCitta() %>"
                                        disabled>
                                        <br>
